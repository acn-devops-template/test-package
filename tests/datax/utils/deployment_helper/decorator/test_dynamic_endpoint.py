...
from src.datax.utils.deployment_helper.decorator.dynamic_endpoint import register_dynamic_endpoint
...
def test_dynamic_endpoint_execute(obj: Dict[Callable], 
                               module_name: str, 
                               arg_a: int, 
                               arg_b: int) -> Any:
...
def test_dynamic_endpoint_main() -> bool:
    ...
    parser.add_argument("--module", help="test module name", default="test_dynamic_endpoint_execute")
    parser.add_argument("--x", help="a random numerical", default = 7)
    parser.add_argument("--y", help="a random numerical", default = 7)
    args = parser.parse_args()
    
    result_test = test_dynamic_endpoint_execute(_dynamic_endpoint, args.module, args.x, args.y)
