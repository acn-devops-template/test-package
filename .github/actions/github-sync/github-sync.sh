...
git config --unset-all http."https://dssgit.se.scb.co.th/".extraheader || :

echo "Resetting origin to: https://$GITHUB_ACTOR:$GITHUB_TOKEN@dssgit.se.scb.co.th/$GITHUB_REPOSITORY"
git remote set-url origin "https://$GITHUB_ACTOR:$GITHUB_TOKEN@dssgit.se.scb.co.th/$GITHUB_REPOSITORY"
